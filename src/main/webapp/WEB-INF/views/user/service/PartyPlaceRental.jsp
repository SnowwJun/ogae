...
<!--      <div class="image-container"> -->
    <div class="slider-container">
        <div class="slider">
            <div class="slide"><img src="https://ogae-dog.s3.ap-northeast-2.amazonaws.com/upload/service/202312071953825001.jpg" alt="이미지 1"></div>
        </div>
        </div>
        ...
        <div class="preview-content">
          <button type="button" class="btn__close">닫기</button>
            ...
            <h2>Party Room Rental</h2>
             <p>현재 파티룸을 운영되지 않고 있습니다. 포토존은 이용 가능하니 많이 놀러와 주세요! </p>
